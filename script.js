  ...
  <div class="col-md-6 col-lg-4 mt-3" id=${id} key=${id}>
    <div class='card shadow-sm task__card'>
      ...
      <div class='card-header d-flex justify-content-end task__card__header'>
          ...
          <i class='fa-solid fa-pencil fa-bounce name=${id}'></i>
          </button>
           <button type='button' class='btn btn-outline-danger mr-1.5' name=${id} onclick="deleteTask.apply(this, arguments)">
           <i class='fa-solid fa-trash fa-bounce name=${id}' onclick="deleteTask.apply(this, arguments)"></i>
          </button>
      </div>
      <div class='card-body'>
          ${
            ...
            :`<img width='100%' src='https://t3.ftcdn.net/jpg/02/48/42/64/360_F_248426448_NVKLywWqArG2ADUxDq6QprtIzsF82dMF.jpg' alt='Card Image' class='card-img-top md-3 rounded-lg' />`
          }
...
// console.log(type);
const removeTask = state.taskList.find(({id}) => id !==targetId);
